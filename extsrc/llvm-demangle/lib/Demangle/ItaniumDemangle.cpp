...
struct DumpVisitor {
    ...
    template <class T> typename std::enable_if<std::is_unsigned<T>::value>::type print(T N) {
        fprintf(stderr, "%llu", (unsigned long long)N);
    }

    template <class T> typename std::enable_if<std::is_signed<T>::value>::type print(T N) {
...
ItaniumPartialDemangler::ItaniumPartialDemangler()
    : RootNode(nullptr)
    , Context(new Demangler{nullptr, nullptr}) {}
